...
sources = modules2filepaths "hs" "library" $
  "MTG.Types MTG.Types.Prelude MTG.Classes.Prelude MTG.Classes.Print MTG.Classes.Parse MTG.Types.Errors MTG.Text.List.Colors MTG.Natural.CMC MTG.Enum.Color \
