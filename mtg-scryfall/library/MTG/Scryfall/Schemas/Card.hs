...
@
{
  ...
  "related_uris": {
    ...
    "mtgtop8"         : "<http://mtgtop8.com/search?MD_check=1&SB_check=1&cards=Llanowar+Elve>s"
  },
  "purchase_uris"     : {
...
import MTG.Scryfall.Schemas.Types
import MTG.Scryfall.Schemas.Image ( ImageObject(..) )
...
data CardObject = CardObject
 ...
 { object         :: String  -- ^ e.g. @"card"@
 , name           :: String -- ^ e.g. @"Llanowar Elves"@
 , id             :: Identifier -- ^ e.g. @"73542493-cd0b-4bb7-a5b8-8f889c76e4d6"@
 , oracle_id      :: Identifier -- ^ e.g. @"68954295-54e3-4303-a6bc-fc4547a4e3a3"@
 , multiverse_ids :: [Identifier] -- ^ e.g. @[]@
 , lang           :: Language -- ^ e.g. @"en"@
 , uri            :: URI -- ^ e.g. @"https://api.scryfall.com/cards/m19/314"@
 , scryfall_uri   :: URI -- ^ e.g. @"https://scryfall.com/card/m19/314?utm_source=api"@
 , layout         :: Layout -- ^ e.g. @"normal"@
 , highres_image  :: Bool,
 , image_uris     :: ImageObject ""
 , mana_cost      :: ManaCost -- ^ e.g. @"{G}"@
 , cmc            :: ConvertedManaCost -- ^ e.g. @1@
 , type_line      :: String -- ^ e.g. @"Creature — Elf Druid"@
 , oracle_text    :: String -- ^ e.g. @"{T}: Add {G}."@
 , power          :: Numeric -- ^ e.g. @"1"@
 , toughness      :: Numeric -- ^ e.g. @"1"@
 , colors         :: [Color] -- ^ e.g. @['ColorBlue']@
 , color_identity :: [Color] -- ^ e.g. @['ColorBlue']@
 , legalities     :: Legalities -- ^ e.g. @Map.fromList [("vintage",'Restricted'),("legacy",'Banned'),...]@
 , reserved          :: Boolean
 , foil              :: Boolean
 , nonfoil           :: Boolean
 , oversized         :: Boolean
 , reprint           :: Boolean
  "set"               : String "m19",
  "set_name"          : String "Core Set 2019",
  "set_uri"           : URI "https://api.scryfall.com/sets/m19",
  "set_search_uri"    : URI "https://api.scryfall.com/cards/search?order=set&q=e%3Am19&unique=prints",
  "scryfall_set_uri"  : URI "https://scryfall.com/sets/m19?utm_source=api",
  "rulings_uri"       : URI "https://api.scryfall.com/cards/m19/314/rulings",
  "prints_search_uri" : URI "https://api.scryfall.com/cards/search?order=set&q=%21%E2%80%9CLlanowar+Elves%E2%80%9D&unique=prints",
  "collector_number"  : String "314",
 , digital           :: Boolean
  "rarity"            : Rarity "common",
  "flavor_text"       : String "As patient and generous as life, as harsh and merciless as nature.",
  "illustration_id"   : Identifier "82c0ea68-cf37-41ec-aec7-123e8e9f05d3",
  "artist"            : String "Chris Rahn",
  "frame"             : Frame "2015",
 , full_art          :: Boolean
 , border_color      :: BorderColor -- ^ e.g. @'BlackBorder'@
 , timeshifted       :: Boolean
